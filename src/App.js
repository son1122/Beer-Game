    ...
    return (
        <div>
            ...
            <div>
                <Routes>
                    <Route path="/"
                           element={<Main country={country} countryCode={countryCode} setCountry={setCountry}/>}/>
                    <Route path="/about" element={<About/>}/>
                    <Route path="/game/" element={<Player whoPlay={whoPlay} setWhoPlay={setWhoPlay} player={player}
                                                          setPlayer={setPlayer}
                                                          price={price} turn={turn} setTurn={setTurn} player1={player1}
                                                          setPlayer1={setPlayer1}
                                                          player2={player2} setPlayer2={setPlayer2} player3={player3}
                                                          setPlayer3={setPlayer3}
                                                          player4={player4} setPlayer4={setPlayer4} manu={manu}
                                                          setManu={setManu}/>}/>
