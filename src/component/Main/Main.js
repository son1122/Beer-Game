    ...
    return (
        <div className="main-container">
            ...
            <div className="country">
                ...
                {props.country == null &&
                    <input type="text" id="search" name="Search Country" placeholder="Search Country"></input>}
                {props.country == null &&
                    <div className="country-list">
                        {list}
                    </div>}
                {props.country != null && <h2>Your country code is {props.country}</h2>}
                {props.country != null && <button onClick={() => {
                    props.setCountry(null)
                }} style={{width: "30%", height: "25%"}}>Press this to clear</button>}
            </div>
        </div>
    );
};
